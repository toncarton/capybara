...
private
  ...
  def set_date(value, as_keys: false, **) # rubocop:disable Naming/AccessorMethodName
  ...
  def set_time(value, as_keys: false, **) # rubocop:disable Naming/AccessorMethodName
    value = SettableValue.new(value)
  ...
  def set_datetime_local(value, as_keys: false, **) # rubocop:disable Naming/AccessorMethodName
    value = SettableValue.new(value)
    return set_text(value) unless value.timeable?
  ...
  def keystrokes_for_datetime(dt, type)
    format = LOCALE_KEYSTROKES[get_locale][type]
